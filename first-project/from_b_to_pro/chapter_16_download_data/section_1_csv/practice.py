...
def prcp():
    path = Path(__file__).parent / "weather_data" / "death_valley_2021_full.csv"
...
ax.plot(dates, highs, color="orange", alpha=0.3)
ax.plot(dates, lows, color="yellow", alpha=0.3)
ax.fill_between(dates, highs, lows, facecolor="yellow", alpha=0.05)
